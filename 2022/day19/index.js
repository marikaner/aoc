  ...
  return blueprints.reduce((acc, blueprint, index) => {
    ...
    for (let minute = 0; minute < 24; minute++) {
      ...
      for (let state of states) {
        if (
          state.resources.ore >= blueprint.geode.ore &&
        ...
        if (
          state.resources.ore >= blueprint.obsidian.ore &&
          ...
          newStates.push({
            ...
            resources: {
              ore:
                state.resources.ore + state.robots.ore - blueprint.obsidian.ore,
              clay:
      ...
      let fitnesses = newStates.map((state) => {
        return (
          (state.resources.geode + (24 - minute) * state.robots.geode) *
            10000000 +
...
const part2 = async (input) => {
  ...
  return blueprints.reduce((acc, blueprint, index) => {
    ...
    for (let minute = 0; minute < 32; minute++) {
      ...
      let fitnesses = newStates.map((state) => {
        return (
          (state.resources.geode + (32 - minute) * state.robots.geode) *
            10000000 +
          state.robots.obsidian * 10000 +
          state.robots.clay * 100 +
          state.robots.ore
...
console.log(
  part2(`Blueprint 1: Each ore robot costs 3 ore. Each clay robot costs 4 ore. Each obsidian robot costs 3 ore and 10 clay. Each geode robot costs 2 ore and 7 obsidian.
